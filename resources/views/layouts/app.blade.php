...
<head>
    ...
    <title>{{ config('app.name', 'Educa Studio') }}</title>
...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="/category/marbel-and-friends-kind-games">Marbel & Friends - Kids Games</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="/program/kunjungan_industri">Kunjungan Industri</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
...
<footer class="text-center text-white" style="background-color: #f1f1f1;">
  ...
  <div class="text-center text-dark p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2022 Copyright:
    <a class="text-dark" href="#">Iqrima</a>
  </div>
  <!-- Copyright -->
</footer>
</html>
